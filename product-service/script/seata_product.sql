...
-- ----------------------------
BEGIN;
INSERT INTO `branch_transaction` VALUES (36, '192.168.1.4:8091:2012781558', 2012781565, '[{\"productSysNo\":1,\"qty\":2}]', 2, '2019-05-28 14:26:34', '2019-05-28 14:26:34');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `inventory` VALUES (1, 1, 1000000, 999998, 2, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `product` VALUES (1, '刺力王', '从小喝到大的刺力王', '好喝好喝好好喝', '', '', 0, '', 15, 5, 5, 5, 1, '', 1, '2019-05-28 03:36:17', '', '', '2019-05-28 03:36:44');
COMMIT;
